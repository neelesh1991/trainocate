                  ...
                  <div class="col-md-12">
                    ...
                    <div class="panel widget">
                      ...
                      <div class="panel-heading vd_bg-grey">
                        ...
                        <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-th-list"></i>  </span><!--  Data Tables Example --> Manage User Logs and Retry Assessment</h3>
                     ...
                     <?php /* <div class="modal fade" id="csvUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                              ...
                              <form action="<?php echo base_url();?>users/add" class="form-horizontal" id="AddUser" method="POST" role="form"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <label class="col-sm-4 control-label">Company POC :</label>
                        ...
                        <table class="table table-striped" id="data-tables">
                          ...
                          <thead>
                            ...
                            <tr>
                              ...
                              <th>Reset Exam Logs</th>

                              <th>Reset Assessment (Retry Assessment)</th>
