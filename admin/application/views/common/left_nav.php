      ...
      <ul>
        ...
        <li  <?php if($this->uri->segment(1)=='manage_quiz')
          ...
          <a class="themeColorhower" href="<?php echo base_url();?>manage_quiz">
            ...
            <span class="menu-text">Manage Assessment Master</span>
        ...
        <li  <?php if($this->uri->segment(1)=='manage_quiz_section')
          ...
          <a class="themeColorhower" href="<?php echo base_url();?>manage_quiz_section">
            ...
            <span class="menu-text">Manage Assessment Section</span>
        ...
        <!-- <li  <?php //if($this->uri->segment(1)=='manage_user_logs')

          {?> class="active" <?php } ?>>

          <a class="themeColorhower" href="<?php //echo base_url();?>manage_user_logs">

            <span class="menu-icon"><span class="glyphicon glyphicon-user"></span></span>

            <span class="menu-text">Manage User Logs</span>
       ...
       <div class="vd_head-section clearfix">
         ...
         <div class="vd_panel-header">
           ...
           <?php if($this->uri->segment(1)=='tenant')    {?>
            ...
            <li class="active">Manage Assessment Section </li>
            ...
            <?php  //if($this->uri->segment(1)=='manage_user_logs')  {  ?>
