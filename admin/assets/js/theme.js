		...
		*/
		$('[data-action^="click-trigger"]').click(function(e) {
			...
			if ( $(this).parent().parent().parent().data("action") != "click-target" && $(this).parent().parent().parent().parent().parent().data("action") != "click-target"    )  {
				$('[data-action^="click-target"]').slideUp('fast',  function(){ //setHeight();
					});
			} else{
			// check if children of click-target then slideup all the parent kids
				...
				$(this).parent().siblings().children('[data-action^="click-target"]').slideUp('fast',  function(){//setHeight();
			...
			if (! $(this).hasClass('open')){
				...
				$(this).addClass('open');
				$(this).parent().children('[data-action^="click-target"]').slideDown('fast',  function(){    if ($('.navbar-menu').outerHeight() < $('.navbar-menu .vd_menu').outerHeight() + $('.navbar-spacing ').outerHeight()){setHeight()};
