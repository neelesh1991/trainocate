...

{
  ...
  // public function get_total_users($tenant_id)
   public function get_total_users($tenant_id,$admin_level)
  {
  ...
  public function get_total_exams($tenant_id,$admin_level)
  {
  ...
  public function get_total_question($tenant_id,$admin_level)
  {
...
public function getQuizLogData($tenant_id,$exam_id="",$admin_level)
  ...
  function retryLogData($tenant_id,$exam_id="",$admin_level){
