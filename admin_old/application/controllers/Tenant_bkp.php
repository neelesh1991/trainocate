...

{
	...
	public function getAjaxdataObjects()
	{
		...
		$this->form_validation->set_rules('notification_email','Notification Email','trim|required|valid_email|is_unique[admin.notification_email]');
			...
			if ($this->form_validation->run())
			{
				...
				if($_FILES['logo']['name']!='')
				{
					...
					$insertDataTenant=array('name'=>$this->input->post('name',TRUE),'header_color'=>$header_color,'created'=>date('Y-m-d H:i:s'),'url'=>$this->input->post('url',TRUE),'timezone'=>$this->input->post('time_zone',TRUE),'signup_permission'=>$this->input->post('signup_permission',TRUE),'address'=>$this->input->post('address',TRUE),'notification_email'=>$this->input->post('notification_email',TRUE));
					...
					$insertDataAdmin=array('name'=>$this->input->post('admin_name',TRUE),'level'=>2,'password'=>md5($adminPwd),'email'=>$this->input->post('email',TRUE),'created'=>date('Y-m-d H:i:s'),'tenant_id'=>$res,'contact'=>$this->input->post('contact',TRUE),'notification_email'=>$this->input->post('notification_email',TRUE));
					...
					if($res1 > 0)
					{
						...
						$notificationemail =$this->test_model->get_tenant_notification_email($tenantInfo['id']);
						...
						//$emailData=array('to'=>$_POST['email'],'fromEmail'=>'quizadmin@emmersivedemos.in','subject'=>$emaildata['subject'],'template'=>$msg);

						$emailData=array('to'=>$_POST['email'],'fromEmail'=>$notificationemail['notification_email'],'subject'=>$emaildata['subject'],'template'=>$msg);
		...
		public function edit()
		{
			...
			//$this->form_validation->set_rules('notification_email','Notification Email','trim|required|valid_email|is_unique[admin.nootification_email]');
			...
			if ($this->form_validation->run())
			{
				if($this->input->post('id',TRUE)!='')
				{
					...
					if($_FILES['logo']['name']!='')
					{
						...
						$data=array('url'=>$this->input->post('url',TRUE),'name'=>$this->input->post('name',TRUE),'header_color'=>$this->input->post('header_color',TRUE),'logo'=>$img,'timezone'=>$this->input->post('time_zone',TRUE),'signup_permission'=>$this->input->post('signup_permission',TRUE),'address'=>$this->input->post('address',TRUE),'notification_email'=>$this->input->post('notification_email',TRUE));
					...
					{
						$data=array('url'=>$this->input->post('url',TRUE),'name'=>$this->input->post('name',TRUE),'header_color'=>$this->input->post('header_color',TRUE),'timezone'=>$this->input->post('time_zone',TRUE),'signup_permission'=>$this->input->post('signup_permission',TRUE),'address'=>$this->input->post('address',TRUE),'notification_email'=>$this->input->post('notification_email',TRUE));
