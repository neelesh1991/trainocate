                    ...
                    <div class="modal-body">
                      ...
                      <!--<div class="form-group">
                        <label class="col-sm-3 control-label">Notification Email:</label>
                          <div class="col-sm-9 controls">
                            <input type="text" class="input-border-btm" id="notification_email" name="notification_email" placeholder="Enter Notification Email">
                          </div>
                      </div>-->

                      <div class="form-group">
                        <label class="col-sm-4 control-label">Manually Sign up</label>
