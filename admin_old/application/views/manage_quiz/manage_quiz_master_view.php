                ...
                <div class="col-md-12">
                  ...
                  <div class="panel widget">
                    ...
                    <div class="panel-heading vd_bg-grey">
                      ...
                      <h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-th-list"></i> </span>   Manage Quiz Master</h3>

                    </div>

                    <div class="panel-body table-responsive">

                      <button class="btn vd_bg-blue " data-target="#quizModal" id="addquiz" data-toggle="modal"><i class="fa  fa-plus"></i> Add New Quiz </button>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-header vd_bg-blue vd_white">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Add/Edit Quiz</h4>
                            ...
                            <div class="modal-body">
                              ...
                              <form action="<?php echo base_url();?>manage_quiz/submit_quiz" class="form-horizontal" id="manage_quiz" method="POST" role="form"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  ...
                                  <label class="col-sm-4 control-label">Quiz Name :</label>
